export function createProgrammingPrompt(subject, namespaceToFilter, classMapping, namespaces, formattedSourceDocuments){

    const prompt = `
    
    ${namespaceToFilter} Coding & Problem Solving:

    This class is a programming class. You must never ever give coding solutions to students.
